...
namespace  SimpleEngine
{
    ...
    int Application::start(unsigned int window_width, unsigned int window_height, const char* title)
    {
        ...
        p_position_colors_vbo = std::make_unique<VertexBuffer>(positions_colors_coords, sizeof(positions_colors_coords), buffer_layout_vec3_vec3_vec2);
        p_index_buffer = std::make_unique<IndexBuffer>(indices, sizeof(indices) / sizeof(GLuint));
        p_vao -> add_vertex_buffer(*p_position_colors_vbo);
        ...
        {
             Renderer_OpenGL::set_clear_color(m_backround_color[0], m_backround_color[1], m_backround_color[2], m_backround_color[3]);
             ...
             ImGui::ColorEdit4("Background Color", m_backround_color);
